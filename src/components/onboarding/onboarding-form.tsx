      ...
      <section className="profile-workspace">
        ...
        <form onSubmit={handleContinue} noValidate>
          ...
          {step === 1 ? <div className="profile-fields">
            ...
            <Field label="Your full name" error={errors.fullName}><input value={form.fullName} onChange={(e) => setField("fullName", e.target.value)} placeholder="Enter your full name" autoComplete="name" aria-invalid={Boolean(errors.fullName)} /></Field>
          ...
          {step === 4 ? <div className="profile-fields">
            ...
            <Field label="Public contact email" hint="Website enquiries will be sent here" error={errors.contactEmail}><input type="email" value={form.contactEmail} onChange={(e) => setField("contactEmail", e.target.value)} placeholder="hello@yourpractice.com" aria-invalid={Boolean(errors.contactEmail)} /></Field>
          </div> : null}
